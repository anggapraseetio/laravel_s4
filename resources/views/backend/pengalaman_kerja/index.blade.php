                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group">
                                                    ...
                                                    <!-- Tombol Delete -->
                                                    <form action="{{ route('pengalaman_kerja.destroy', $item->id) }}" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin menghapus data ini?')" style="display:inline;">
                                                        @csrf
                                                        @method('DELETE')
